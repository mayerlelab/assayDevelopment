...
saveRDS(ImputedTrain, "./ml_dataset/ImputedTrain_lewis.rds")
## imupte test
...
ImputedTestComplete <- ImputeTransformScale(test, 
                                     ...
                                     ScaleType = "Auto",
                                     drop.variables=dropvariables)
saveRDS(ImputedTestComplete, "./ml_dataset/ImputedTest_lewis.rds")
...
ImputedValidationComplete <- ImputeTransformScale(validation, 
                                     ...
                                     ScaleType = "Auto",
                                     drop.variables=dropvariables)
saveRDS(ImputedValidationComplete, "./ml_dataset/ImputedValidation_lewis.rds")
...
if (file.exists("./glmnet_models/mfit_lewis.RData")) { load("./glmnet_models/mfit_lewis.RData") 
  } else {
...
mfit_lewis <-glmnet(validationX,
             ...
             keep = TRUE)
# Save model
save(mfit_lewis, file="./glmnet_models/mfit_lewis.RData")
}

## coefficients
coef <- coef(mfit_lewis)
...
ImputedValidation$prediction = predict(mfit_lewis, 
                                  newx = validationX, 
                                  s = mfit_lewis$lambda,
                                  type="response")
```
